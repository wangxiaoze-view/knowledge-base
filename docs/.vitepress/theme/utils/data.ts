...
export const NAV_DATA: NavData[] = [
	{
		...
		items: [
			...
			},
			{
				...
				desc: "基础前端底层库，内置了一些常用的正则",
				link: "https://docs-tools.wangzevw.com/",
			},
			{
				icon: "https://www.wangzevw.com/logo.png",
				title: "HarmonyOs-App",
				...
				desc: "一款仅仅只有布局的鸿蒙软件",
				link: "https://github.com/wangxiaoze-view/HarmonyOs-App",
			},
		],
	},
	{
		...
		items: [
			...
			{
				icon: "https://camo.githubusercontent.com/f5f593dbdf10c5cc223ad8b19c84c31f78cfe01713bb0acb11789142ba8ab293/68747470733a2f2f756d616d692e69732f696d616765732f756d616d692d6c6f676f2e706e67",
				title: "Umami",
				badge: {
					text: "统计",
					type: "tip",
			...
			{
				icon: "//static.json.cn/r/img/favicon/favicon.ico",
				title: "Json 中文网",
				badge: {
					text: "Json格式化",
					type: "tip",
			...
			{
				icon: "https://xn--1-q07a56pdss.com/apple-touch-icon.png",
				title: "一元机场",
				badge: {
					text: "梯子",
					type: "tip",
				...
				desc: "一元机场梯子工具",
				link: "https://xn--1-q07a56pdss.com/#/login",
			},
			{
				icon: "https://xn--1-q07a56pdss.com/apple-touch-icon.png",
				title: "喵酥云",
				...
				desc: "喵酥云梯子工具",
				//  miao.bar https://www.miao.lat/
				link: "https://www.miaosu.xyz/#/dashboard",
			},
		],
	},

	{
		...
		items: [
			{
				icon: "https://www.pdfmao.com/static/images/logo.png",
				title: "PDF 猫",
				badge: {
					text: "档转换工具",
					type: "warning",
...

	{
		...
		items: [
			...
			},
			{
				...
				desc: "基于 mozjpeg，能极速压缩 80%的图片大小，而不损害其质量",
			...
			},
			{
				...
				desc: "免费在线去水印（消除笔）—一键去除水印,杂物,让您轻松摆脱logo,文字,标志,污渍等图片瑕疵",
	...
	},
	{
		...
		items: [
			{
				icon: "https://www.postcss.com.cn/assets/logo-tq8kLoG9.svg",
				title: "PostCSS",
	...
	},
	{
		...
		items: [
			...
			{
				icon: "https://ionic.io/ionicons/assets/img/meta/ionicons-og.png",
				title: "ionic",
				desc: "适用于网络、iOS、Android 和桌面应用的优质设计图标。支持 SVG。",
